...
#pragma endregion
    ...
    if (nChar == VK_NUMPAD4) m_glRenderer.eyeX -= 0.01;
    if (nChar == VK_NUMPAD6) m_glRenderer.eyeX += 0.01;
    if (nChar == VK_NUMPAD8) m_glRenderer.eyeY += 0.01;
    if (nChar == VK_NUMPAD5) m_glRenderer.eyeY -= 0.01;
    if (nChar == VK_NUMPAD7) m_glRenderer.eyeZ += 0.01;
    if (nChar == VK_NUMPAD9) m_glRenderer.eyeZ -= 0.01;
