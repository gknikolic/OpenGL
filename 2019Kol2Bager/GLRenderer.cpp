...
void CGLRenderer::PrepareScene(CDC* pDC)
{
    ...
    //UCITAVANJE TEKSTURE
    excavator = LoadTexture("./Teksture//excavator.png");
    front = LoadTexture("./Teksture//front.jpg");
    left = LoadTexture("./Teksture//left.jpg");
    right = LoadTexture("./Teksture//right.jpg");
    back = LoadTexture("./Teksture//back.jpg");
    top = LoadTexture("./Teksture//top.jpg");
    bot = LoadTexture("./Teksture//bot.jpg");
